...
import com.mycompany.proyecto1_ss24.backend.model.CreadorComentario;
...
public class NuevoComentarioServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        CreadorComentario creadorRevistas = new CreadorComentario();
        try {
            creadorRevistas.crearComentario(request, idUsuario, idRevista);
            try (PrintWriter out = response.getWriter()) {
                out.println("<h1>Se creo el Comentario para la Revista Correctamente!!!</h1>");
            }
