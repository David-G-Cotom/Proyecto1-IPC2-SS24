 ...
 * @author Carlos Cotom
 */
public class CreadorBuyAdTextImage {

    private final CompraAnuncioDB dataCompra = new CompraAnuncioDB();
    private AnuncioTextoImagen anuncio;
    private Pago pago;

    public AnuncioTextoImagen crearCompra(HttpServletRequest request, int idUsuario) throws UserDataInvalidException, UserActionInvalidException {
        ...
        dataCompra.crearAnuncioTextoImagen(anuncio);
    ...
    private void extraerYValidar(HttpServletRequest request, int idInversionista) throws UserDataInvalidException, UserActionInvalidException {
        ...
        try {
            ...
            throw new UserDataInvalidException("Error en el Campo para Seleccionar el Archivo de Imagen");
        }
        this.isValidateCreation(fecha, duracionDias, contenidoAnuncio, tituloAnuncio, filePart.getSubmittedFileName());
        ...
        this.anuncio = new AnuncioTextoImagen(contenidoAnuncio, inputStream, costoCompra, vigenciaDias, true, idInversionista, idPeriodoTiempo, idTipoAnuncio);
        this.anuncio.setTitulo(tituloAnuncio);
        this.pago = new Pago(costoCompra, fecha, idInversionista);
    }

    private void isValidateCreation(LocalDate fecha, String duracionDias, String contenido, String titulo, String fileName) throws UserDataInvalidException {
        if (fecha == null) {
        ...
        if (fileName.equals("")) {
            throw new UserDataInvalidException("Debe Seleccionar una Imagen para el Anuncio");
        }
