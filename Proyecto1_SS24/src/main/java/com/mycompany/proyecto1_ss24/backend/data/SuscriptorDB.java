...
public class SuscriptorDB {
    ...
    public ArrayList<Revista> getRevistasSuscritasFiltro(int idSuscriptor, String[] etiquetas, String[] categorias) throws UserDataInvalidException {
        ...
        if (idsRevistasSuscritas.isEmpty()) {
            throw new UserDataInvalidException("Aun no Tienes Revistas Suscritas!!!");
        }
        if (etiquetas != null) {
        ...
        ArrayList<Revista> revistasFiltradasEtiqueta = this.getRevistasFiltradas(idsRevistasFiltradas);
        return revistasFiltradasEtiqueta;
    }
    ...
    private ArrayList<Integer> getIdsTipoEtiquetas(String[] etiquetas) {
    ...
    private ArrayList<Integer> getIdsCategoria(String[] categorias) {
